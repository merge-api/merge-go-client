...
package file_storage_force_resync_test
...
func TestFileStorageForceResyncSyncStatusResyncCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FileStorage.ForceResync.SyncStatusResyncCreate(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/filestorage/v1/sync-status/resync", nil, 1)
}
