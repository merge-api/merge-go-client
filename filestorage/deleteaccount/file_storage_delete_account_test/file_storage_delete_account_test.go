...
package file_storage_delete_account_test
...
func TestFileStorageDeleteAccountDeleteWithWireMock(
	t *testing.T,
) {
	...
	invocationErr := client.FileStorage.DeleteAccount.Delete(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/filestorage/v1/delete-account", nil, 1)
}
