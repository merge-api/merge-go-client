...
package file_storage_users_test
...
func TestFileStorageUsersListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FileStorage.Users.List(
		context.TODO(),
		request,
	)
...
func TestFileStorageUsersRetrieveWithWireMock(
	...
	_, invocationErr := client.FileStorage.Users.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/filestorage/v1/users/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
