...
package file_storage_regenerate_key_test
...
func TestFileStorageRegenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FileStorage.RegenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/filestorage/v1/regenerate-key", nil, 1)
}
