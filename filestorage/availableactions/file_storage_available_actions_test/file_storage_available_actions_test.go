...
package file_storage_available_actions_test
...
func TestFileStorageAvailableActionsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FileStorage.AvailableActions.Retrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/filestorage/v1/available-actions", nil, 1)
}
