...
package file_storage_generate_key_test
...
func TestFileStorageGenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FileStorage.GenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/filestorage/v1/generate-key", nil, 1)
}
