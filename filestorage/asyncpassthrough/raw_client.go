...
func (r *RawClient) Create(
...
) (*core.Response[*filestorage.AsyncPassthroughReciept], error) {
	...
	return &core.Response[*filestorage.AsyncPassthroughReciept]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*filestorage.AsyncPassthroughRetrieveResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/filestorage/v1/async-passthrough/%v",
	...
	return &core.Response[*filestorage.AsyncPassthroughRetrieveResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
