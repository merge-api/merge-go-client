...
func (c *Client) DefaultScopesRetrieve(ctx context.Context) (*filestorage.CommonModelScopeApi, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "api/filestorage/v1/default-scopes"
...
func (c *Client) LinkedAccountScopesRetrieve(ctx context.Context) (*filestorage.CommonModelScopeApi, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "api/filestorage/v1/linked-account-scopes"
...
func (c *Client) LinkedAccountScopesCreate(ctx context.Context, request *filestorage.LinkedAccountCommonModelScopeDeserializerRequest) (*filestorage.CommonModelScopeApi, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
