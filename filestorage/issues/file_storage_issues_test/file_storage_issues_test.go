...
package file_storage_issues_test
...
func TestFileStorageIssuesListWithWireMock(
	t *testing.T,
) {
...
func TestFileStorageIssuesRetrieveWithWireMock(
	...
	_, invocationErr := client.FileStorage.Issues.Retrieve(
		context.TODO(),
		"id",
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/filestorage/v1/issues/id", nil, 1)
}
