...
package file_storage_passthrough_test
...
func TestFileStoragePassthroughCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FileStorage.Passthrough.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/filestorage/v1/passthrough", nil, 1)
}
