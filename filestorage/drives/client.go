...
func (c *Client) List(
...
) (*core.Page[*filestorage.Drive], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *filestorage.PaginatedDriveList) *internal.PageResponse[*string, *filestorage.Drive] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *filestorage.Drive]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
...
func (c *Client) Retrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/filestorage/v1/drives/%v",
		id,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
