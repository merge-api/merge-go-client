...
package file_storage_link_token_test
...
func TestFileStorageLinkTokenCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FileStorage.LinkToken.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/filestorage/v1/link-token", nil, 1)
}
