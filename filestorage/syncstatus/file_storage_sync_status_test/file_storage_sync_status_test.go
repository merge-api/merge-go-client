...
package file_storage_sync_status_test
...
func TestFileStorageSyncStatusListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FileStorage.SyncStatus.List(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/filestorage/v1/sync-status", map[string]string{"cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "page_size": "1"}, 1)
}
