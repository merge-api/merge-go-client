...
type Client interface {
	List(ctx context.Context, request *filestorage.GroupsListRequest) (*filestorage.PaginatedGroupList, error)
	Retrieve(ctx context.Context, id string, request *filestorage.GroupsRetrieveRequest) (*filestorage.Group, error)
}
...
func (c *client) List(ctx context.Context, request *filestorage.GroupsListRequest) (*filestorage.PaginatedGroupList, error) {
	...
	var response *filestorage.PaginatedGroupList
