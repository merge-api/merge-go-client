...
func (c *Client) List(
...
) (*core.Page[*filestorage.Group], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *filestorage.PaginatedGroupList) *internal.PageResponse[*string, *filestorage.Group] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *filestorage.Group]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
...
func (c *Client) Retrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/filestorage/v1/groups/%v",
		id,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
	...
	var response *filestorage.Group
