...
package file_storage_groups_test
...
func TestFileStorageGroupsListWithWireMock(
	t *testing.T,
) {
...
func TestFileStorageGroupsRetrieveWithWireMock(
	...
	_, invocationErr := client.FileStorage.Groups.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/filestorage/v1/groups/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
