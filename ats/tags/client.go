...
func (c *Client) List(
...
) (*core.Page[*string, *ats.Tag, *ats.PaginatedTagList], error) {
	...
	readPageResponse := func(response *ats.PaginatedTagList) *core.PageResponse[*string, *ats.Tag, *ats.PaginatedTagList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ats.Tag, *ats.PaginatedTagList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
