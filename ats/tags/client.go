...
func (c *Client) List(
...
) (*core.Page[*string, *ats.Tag], error) {
	...
	readPageResponse := func(response *ats.PaginatedTagList) *core.PageResponse[*string, *ats.Tag] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ats.Tag]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
