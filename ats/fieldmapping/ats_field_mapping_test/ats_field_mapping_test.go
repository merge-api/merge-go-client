...
package ats_field_mapping_test
...
func TestAtsFieldMappingFieldMappingsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ats.FieldMapping.FieldMappingsRetrieve(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/field-mappings", map[string]string{"exclude_remote_field_metadata": "true"}, 1)
}

func TestAtsFieldMappingFieldMappingsCreateWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Ats.FieldMapping.FieldMappingsCreate(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ats/v1/field-mappings", map[string]string{"exclude_remote_field_metadata": "true"}, 1)
}

func TestAtsFieldMappingFieldMappingsDestroyWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
...
func TestAtsFieldMappingFieldMappingsPartialUpdateWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
...
func TestAtsFieldMappingRemoteFieldsRetrieveWithWireMock(
	...
	_, invocationErr := client.Ats.FieldMapping.RemoteFieldsRetrieve(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/remote-fields", map[string]string{"common_models": "common_models", "include_example_values": "include_example_values"}, 1)
}

func TestAtsFieldMappingTargetFieldsRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Ats.FieldMapping.TargetFieldsRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/target-fields", nil, 1)
}
