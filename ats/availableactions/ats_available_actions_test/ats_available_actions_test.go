...
package ats_available_actions_test
...
func TestAtsAvailableActionsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ats.AvailableActions.Retrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/available-actions", nil, 1)
}
