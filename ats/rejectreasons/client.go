...
type Client interface {
	List(ctx context.Context, request *ats.RejectReasonsListRequest) (*ats.PaginatedRejectReasonList, error)
	Retrieve(ctx context.Context, id string, request *ats.RejectReasonsRetrieveRequest) (*ats.RejectReason, error)
}
