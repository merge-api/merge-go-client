...
package ats_regenerate_key_test
...
func TestAtsRegenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ats.RegenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ats/v1/regenerate-key", nil, 1)
}
