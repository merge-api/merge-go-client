...
type Eeoc struct {
	...
	Race *RaceEnum `json:"race,omitempty" url:"race,omitempty"`
	...
	// * `I_DONT_WISH_TO_ANSWER` - I_DONT_WISH_TO_ANSWER
	VeteranStatus *VeteranStatusEnum `json:"veteran_status,omitempty" url:"veteran_status,omitempty"`
	// The candidate's disability status.
	//
	// * `YES_I_HAVE_A_DISABILITY_OR_PREVIOUSLY_HAD_A_DISABILITY` - YES_I_HAVE_A_DISABILITY_OR_PREVIOUSLY_HAD_A_DISABILITY
	// * `NO_I_DONT_HAVE_A_DISABILITY` - NO_I_DONT_HAVE_A_DISABILITY
	// * `I_DONT_WISH_TO_ANSWER` - I_DONT_WISH_TO_ANSWER
	DisabilityStatus *DisabilityStatusEnum `json:"disability_status,omitempty" url:"disability_status,omitempty"`
	// Indicates whether or not this object has been deleted in the third party platform. Full coverage deletion detection is a premium add-on. Native deletion detection is offered for free with limited coverage. [Learn more](https://docs.merge.dev/integrations/hris/supported-features/).
...
func (e *Eeoc) GetGender() *GenderEnum {
	if e == nil {
		return nil
	}
	return e.Gender
...
func (e *Eeoc) GetVeteranStatus() *VeteranStatusEnum {
	if e == nil {
		return nil
	}
...
func (e *Eeoc) GetDisabilityStatus() *DisabilityStatusEnum {
	if e == nil {
		return nil
	}
