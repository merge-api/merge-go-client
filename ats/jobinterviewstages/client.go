...
type Client interface {
	List(ctx context.Context, request *ats.JobInterviewStagesListRequest) (*ats.PaginatedJobInterviewStageList, error)
	Retrieve(ctx context.Context, id string, request *ats.JobInterviewStagesRetrieveRequest) (*ats.JobInterviewStage, error)
}
