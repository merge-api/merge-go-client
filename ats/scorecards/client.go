...
func (c *Client) List(
	...
	readPageResponse := func(response *ats.PaginatedScorecardList) *internal.PageResponse[*string, *ats.Scorecard] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *ats.Scorecard]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
