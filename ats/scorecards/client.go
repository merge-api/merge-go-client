...
type Client interface {
	List(ctx context.Context, request *ats.ScorecardsListRequest) (*ats.PaginatedScorecardList, error)
	Retrieve(ctx context.Context, id string, request *ats.ScorecardsRetrieveRequest) (*ats.Scorecard, error)
}
