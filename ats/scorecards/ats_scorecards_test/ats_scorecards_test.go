...
func TestAtsScorecardsListWithWireMock(
	t *testing.T,
) {
...
func TestAtsScorecardsRetrieveWithWireMock(
	...
	_, invocationErr := client.Ats.Scorecards.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/scorecards/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true", "remote_fields": "overall_recommendation", "show_enum_origins": "overall_recommendation"}, 1)
}
