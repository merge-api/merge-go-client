...
package ats_async_passthrough_test
...
func TestAtsAsyncPassthroughCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ats.AsyncPassthrough.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ats/v1/async-passthrough", nil, 1)
}

func TestAtsAsyncPassthroughRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Ats.AsyncPassthrough.Retrieve(
		context.TODO(),
		"async_passthrough_receipt_id",
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/async-passthrough/async_passthrough_receipt_id", nil, 1)
}
