...
func (c *Client) List(
	...
	readPageResponse := func(response *ats.PaginatedActivityList) *internal.PageResponse[*string, *ats.Activity] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *ats.Activity]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
