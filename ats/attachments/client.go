...
func (c *Client) List(
...
) (*core.Page[*string, *ats.Attachment], error) {
	...
	readPageResponse := func(response *ats.PaginatedAttachmentList) *core.PageResponse[*string, *ats.Attachment] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ats.Attachment]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
