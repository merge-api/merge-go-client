...
func (c *Client) List(
...
) (*core.Page[*ats.Attachment], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *ats.PaginatedAttachmentList) *internal.PageResponse[*string, *ats.Attachment] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *ats.Attachment]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
