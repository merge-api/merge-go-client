...
func (c *Client) List(
...
) (*core.Page[*string, *ats.Attachment, *ats.PaginatedAttachmentList], error) {
	...
	readPageResponse := func(response *ats.PaginatedAttachmentList) *core.PageResponse[*string, *ats.Attachment, *ats.PaginatedAttachmentList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ats.Attachment, *ats.PaginatedAttachmentList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
