...
func (r *RawClient) Create(
...
) (*core.Response[*ats.AttachmentResponse], error) {
	...
	return &core.Response[*ats.AttachmentResponse]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*ats.Attachment], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*ats.Attachment]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
