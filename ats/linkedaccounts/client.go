...
func (c *Client) List(
...
) (*core.Page[*ats.AccountDetailsAndActions], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *ats.PaginatedAccountDetailsAndActionsList) *internal.PageResponse[*string, *ats.AccountDetailsAndActions] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *ats.AccountDetailsAndActions]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
