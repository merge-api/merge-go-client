...
package ats_account_details_test
...
func TestAtsAccountDetailsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ats.AccountDetails.Retrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/account-details", nil, 1)
}
