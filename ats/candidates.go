...
func (e *EmailAddressRequest) GetEmailAddressType() *EmailAddressTypeEnum {
	if e == nil {
		return nil
	}
...
func (p *PhoneNumberRequest) GetPhoneNumberType() *PhoneNumberTypeEnum {
	if p == nil {
		return nil
	}
...
func (u *UrlRequest) GetUrlType() *UrlTypeEnum {
	if u == nil {
		return nil
	}
	return u.UrlType
