...
func TestAtsPassthroughCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ats.Passthrough.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ats/v1/passthrough", nil, 1)
}
