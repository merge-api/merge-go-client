...
func (c *Client) List(
...
) (*core.Page[*ats.Department], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *ats.PaginatedDepartmentList) *internal.PageResponse[*string, *ats.Department] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *ats.Department]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
