...
func TestAtsScopesDefaultScopesRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ats.Scopes.DefaultScopesRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/default-scopes", nil, 1)
}

func TestAtsScopesLinkedAccountScopesRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Ats.Scopes.LinkedAccountScopesRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/linked-account-scopes", nil, 1)
}

func TestAtsScopesLinkedAccountScopesCreateWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Ats.Scopes.LinkedAccountScopesCreate(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ats/v1/linked-account-scopes", nil, 1)
}
