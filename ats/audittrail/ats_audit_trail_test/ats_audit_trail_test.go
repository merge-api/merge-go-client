...
func TestAtsAuditTrailListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ats.AuditTrail.List(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/audit-trail", map[string]string{"cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "end_date": "end_date", "event_type": "event_type", "page_size": "1", "start_date": "start_date", "user_email": "user_email"}, 1)
}
