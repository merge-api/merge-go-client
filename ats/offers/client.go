...
type Client interface {
	List(ctx context.Context, request *ats.OffersListRequest) (*ats.PaginatedOfferList, error)
	Retrieve(ctx context.Context, id string, request *ats.OffersRetrieveRequest) (*ats.Offer, error)
}
...
func (c *client) List(ctx context.Context, request *ats.OffersListRequest) (*ats.PaginatedOfferList, error) {
	...
	if request.CreatorId != nil {
		queryParams.Add("creator_id", fmt.Sprintf("%v", *request.CreatorId))
	}
	...
	var response *ats.PaginatedOfferList
...
func (c *client) Retrieve(ctx context.Context, id string, request *ats.OffersRetrieveRequest) (*ats.Offer, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
