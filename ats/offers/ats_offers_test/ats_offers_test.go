...
func TestAtsOffersListWithWireMock(
	t *testing.T,
) {
...
func TestAtsOffersRetrieveWithWireMock(
	...
	_, invocationErr := client.Ats.Offers.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/offers/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true", "remote_fields": "status", "show_enum_origins": "status"}, 1)
}
