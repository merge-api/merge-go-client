...
func TestAtsGenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ats.GenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ats/v1/generate-key", nil, 1)
}
