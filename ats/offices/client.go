...
func (c *Client) List(
...
) (*core.Page[*string, *ats.Office, *ats.PaginatedOfficeList], error) {
	...
	readPageResponse := func(response *ats.PaginatedOfficeList) *core.PageResponse[*string, *ats.Office, *ats.PaginatedOfficeList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ats.Office, *ats.PaginatedOfficeList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
