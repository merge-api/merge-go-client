...
func (c *Client) List(
...
) (*core.Page[*string, *ats.Office], error) {
	...
	readPageResponse := func(response *ats.PaginatedOfficeList) *core.PageResponse[*string, *ats.Office] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ats.Office]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
