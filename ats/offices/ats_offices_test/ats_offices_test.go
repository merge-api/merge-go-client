...
func TestAtsOfficesListWithWireMock(
	t *testing.T,
) {
...
func TestAtsOfficesRetrieveWithWireMock(
	...
	_, invocationErr := client.Ats.Offices.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/offices/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
