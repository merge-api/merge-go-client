...
type Client interface {
	List(ctx context.Context, request *ats.UsersListRequest) (*ats.PaginatedRemoteUserList, error)
	Retrieve(ctx context.Context, id string, request *ats.UsersRetrieveRequest) (*ats.RemoteUser, error)
}
