...
func (c *Client) List(
...
) (*core.Page[*string, *ats.RemoteUser, *ats.PaginatedRemoteUserList], error) {
	...
	readPageResponse := func(response *ats.PaginatedRemoteUserList) *core.PageResponse[*string, *ats.RemoteUser, *ats.PaginatedRemoteUserList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ats.RemoteUser, *ats.PaginatedRemoteUserList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
