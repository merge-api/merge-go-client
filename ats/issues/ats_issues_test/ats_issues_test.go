...
func TestAtsIssuesListWithWireMock(
	t *testing.T,
) {
...
func TestAtsIssuesRetrieveWithWireMock(
	...
	_, invocationErr := client.Ats.Issues.Retrieve(
		context.TODO(),
		"id",
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/issues/id", nil, 1)
}
