...
type Client interface {
	List(ctx context.Context, request *ats.IssuesListRequest) (*ats.PaginatedIssueList, error)
	Retrieve(ctx context.Context, id string) (*ats.Issue, error)
}
...
func (c *client) List(ctx context.Context, request *ats.IssuesListRequest) (*ats.PaginatedIssueList, error) {
	...
	var response *ats.PaginatedIssueList
