...
package ats_delete_account_test
...
func TestAtsDeleteAccountDeleteWithWireMock(
	t *testing.T,
) {
	...
	invocationErr := client.Ats.DeleteAccount.Delete(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ats/v1/delete-account", nil, 1)
}
