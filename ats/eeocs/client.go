...
func (c *Client) List(
	...
	readPageResponse := func(response *ats.PaginatedEeocList) *internal.PageResponse[*string, *ats.Eeoc] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *ats.Eeoc]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
