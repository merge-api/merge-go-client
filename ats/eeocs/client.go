...
func (c *Client) List(
...
) (*core.Page[*string, *ats.Eeoc, *ats.PaginatedEeocList], error) {
	...
	readPageResponse := func(response *ats.PaginatedEeocList) *core.PageResponse[*string, *ats.Eeoc, *ats.PaginatedEeocList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ats.Eeoc, *ats.PaginatedEeocList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
