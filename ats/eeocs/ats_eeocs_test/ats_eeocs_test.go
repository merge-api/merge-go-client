...
func TestAtsEeocsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ats.Eeocs.List(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/eeocs", map[string]string{"candidate_id": "candidate_id", "created_after": "2024-01-15T09:30:00Z", "created_before": "2024-01-15T09:30:00Z", "cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "include_deleted_data": "true", "include_remote_data": "true", "include_shell_data": "true", "modified_after": "2024-01-15T09:30:00Z", "modified_before": "2024-01-15T09:30:00Z", "page_size": "1", "remote_fields": "disability_status", "remote_id": "remote_id", "show_enum_origins": "disability_status"}, 1)
}

func TestAtsEeocsRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Ats.Eeocs.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ats/v1/eeocs/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true", "remote_fields": "disability_status", "show_enum_origins": "disability_status"}, 1)
}
