...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.AccountToken != nil {
		header.Set("X-Account-Token", fmt.Sprintf("%v", *r.AccountToken))
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/merge-api/merge-go-client/v2")
	headers.Set("X-Fern-SDK-Version", "v2.2.0-alpha.1")
	headers.Set("User-Agent", "github.com/merge-api/merge-go-client/2.2.0-alpha.1")
	return headers
}
...
// AccountTokenOption implements the RequestOption interface.
type AccountTokenOption struct {
	AccountToken *string
}

func (a *AccountTokenOption) applyRequestOptions(opts *RequestOptions) {
	opts.AccountToken = a.AccountToken
}
