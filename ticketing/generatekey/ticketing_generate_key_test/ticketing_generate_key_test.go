...
package ticketing_generate_key_test
...
func TestTicketingGenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ticketing.GenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ticketing/v1/generate-key", nil, 1)
}
