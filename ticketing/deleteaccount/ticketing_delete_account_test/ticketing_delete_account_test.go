...
package ticketing_delete_account_test
...
func TestTicketingDeleteAccountDeleteWithWireMock(
	t *testing.T,
) {
	...
	invocationErr := client.Ticketing.DeleteAccount.Delete(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ticketing/v1/delete-account", nil, 1)
}
