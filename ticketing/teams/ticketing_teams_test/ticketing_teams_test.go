...
func TestTicketingTeamsListWithWireMock(
	t *testing.T,
) {
...
func TestTicketingTeamsRetrieveWithWireMock(
	...
	_, invocationErr := client.Ticketing.Teams.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ticketing/v1/teams/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
