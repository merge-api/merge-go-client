...
type Client interface {
	List(ctx context.Context, request *ticketing.TeamsListRequest) (*ticketing.PaginatedTeamList, error)
	Retrieve(ctx context.Context, id string, request *ticketing.TeamsRetrieveRequest) (*ticketing.Team, error)
}
...
func (c *client) List(ctx context.Context, request *ticketing.TeamsListRequest) (*ticketing.PaginatedTeamList, error) {
	...
	var response *ticketing.PaginatedTeamList
