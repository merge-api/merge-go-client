...
type Client interface {
	List(ctx context.Context, request *ticketing.AuditTrailListRequest) (*ticketing.PaginatedAuditLogEventList, error)
}
...
func (c *client) List(ctx context.Context, request *ticketing.AuditTrailListRequest) (*ticketing.PaginatedAuditLogEventList, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "api/ticketing/v1/audit-trail"
	...
	var response *ticketing.PaginatedAuditLogEventList
