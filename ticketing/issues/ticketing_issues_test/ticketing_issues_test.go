...
func TestTicketingIssuesListWithWireMock(
	t *testing.T,
) {
...
func TestTicketingIssuesRetrieveWithWireMock(
	...
	_, invocationErr := client.Ticketing.Issues.Retrieve(
		context.TODO(),
		"id",
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ticketing/v1/issues/id", nil, 1)
}
