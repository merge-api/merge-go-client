...
func (c *Client) List(
...
) (*core.Page[*string, *ticketing.Issue], error) {
	...
	readPageResponse := func(response *ticketing.PaginatedIssueList) *core.PageResponse[*string, *ticketing.Issue] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ticketing.Issue]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
