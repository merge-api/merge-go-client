...
type Client interface {
	List(ctx context.Context, request *ticketing.IssuesListRequest) (*ticketing.PaginatedIssueList, error)
	Retrieve(ctx context.Context, id string) (*ticketing.Issue, error)
}
