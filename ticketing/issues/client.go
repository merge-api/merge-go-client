...
func (c *Client) List(
...
) (*core.Page[*ticketing.Issue], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *ticketing.PaginatedIssueList) *internal.PageResponse[*string, *ticketing.Issue] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *ticketing.Issue]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
