...
func (c *Client) List(
...
) (*core.Page[*string, *ticketing.Issue, *ticketing.PaginatedIssueList], error) {
	...
	readPageResponse := func(response *ticketing.PaginatedIssueList) *core.PageResponse[*string, *ticketing.Issue, *ticketing.PaginatedIssueList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ticketing.Issue, *ticketing.PaginatedIssueList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
