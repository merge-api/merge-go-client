...
type Client interface {
	List(ctx context.Context, request *ticketing.LinkedAccountsListRequest) (*ticketing.PaginatedAccountDetailsAndActionsList, error)
}
...
func (c *client) List(ctx context.Context, request *ticketing.LinkedAccountsListRequest) (*ticketing.PaginatedAccountDetailsAndActionsList, error) {
	...
	var response *ticketing.PaginatedAccountDetailsAndActionsList
