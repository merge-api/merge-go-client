...
func (c *Client) List(
	...
	readPageResponse := func(response *ticketing.PaginatedTagList) *internal.PageResponse[*string, *ticketing.Tag] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *ticketing.Tag]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
