...
func (c *Client) List(
...
) (*core.Page[*string, *ticketing.Tag, *ticketing.PaginatedTagList], error) {
	...
	readPageResponse := func(response *ticketing.PaginatedTagList) *core.PageResponse[*string, *ticketing.Tag, *ticketing.PaginatedTagList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ticketing.Tag, *ticketing.PaginatedTagList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
