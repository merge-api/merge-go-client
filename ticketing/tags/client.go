...
type Client interface {
	List(ctx context.Context, request *ticketing.TagsListRequest) (*ticketing.PaginatedTagList, error)
	Retrieve(ctx context.Context, id string, request *ticketing.TagsRetrieveRequest) (*ticketing.Tag, error)
}
