...
package ticketing_link_token_test
...
func TestTicketingLinkTokenCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ticketing.LinkToken.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ticketing/v1/link-token", nil, 1)
}
