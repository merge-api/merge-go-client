...
func (c *Client) List(
...
) (*core.Page[*string, *ticketing.Account], error) {
	...
	readPageResponse := func(response *ticketing.PaginatedAccountList) *core.PageResponse[*string, *ticketing.Account] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ticketing.Account]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
