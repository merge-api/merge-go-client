...
func (c *Client) List(
...
) (*core.Page[*ticketing.SyncStatus], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *ticketing.PaginatedSyncStatusList) *internal.PageResponse[*string, *ticketing.SyncStatus] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *ticketing.SyncStatus]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
