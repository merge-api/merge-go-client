...
package ticketing_available_actions_test
...
func TestTicketingAvailableActionsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ticketing.AvailableActions.Retrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ticketing/v1/available-actions", nil, 1)
}
