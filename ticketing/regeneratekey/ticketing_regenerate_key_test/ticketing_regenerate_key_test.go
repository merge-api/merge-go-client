...
package ticketing_regenerate_key_test
...
func TestTicketingRegenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ticketing.RegenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ticketing/v1/regenerate-key", nil, 1)
}
