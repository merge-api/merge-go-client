...
package ticketing_passthrough_test
...
func TestTicketingPassthroughCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ticketing.Passthrough.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ticketing/v1/passthrough", nil, 1)
}
