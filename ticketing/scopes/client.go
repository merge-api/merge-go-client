...
func (c *Client) DefaultScopesRetrieve(ctx context.Context) (*ticketing.CommonModelScopeApi, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "api/ticketing/v1/default-scopes"

	var response *ticketing.CommonModelScopeApi
...
func (c *Client) LinkedAccountScopesRetrieve(ctx context.Context) (*ticketing.CommonModelScopeApi, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "api/ticketing/v1/linked-account-scopes"
...
func (c *Client) LinkedAccountScopesCreate(ctx context.Context, request *ticketing.LinkedAccountCommonModelScopeDeserializerRequest) (*ticketing.CommonModelScopeApi, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
