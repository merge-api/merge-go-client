...
func TestTicketingScopesDefaultScopesRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ticketing.Scopes.DefaultScopesRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ticketing/v1/default-scopes", nil, 1)
}

func TestTicketingScopesLinkedAccountScopesRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Ticketing.Scopes.LinkedAccountScopesRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/ticketing/v1/linked-account-scopes", nil, 1)
}

func TestTicketingScopesLinkedAccountScopesCreateWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Ticketing.Scopes.LinkedAccountScopesCreate(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ticketing/v1/linked-account-scopes", nil, 1)
}
