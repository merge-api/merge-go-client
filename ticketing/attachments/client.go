...
func (c *Client) List(
...
) (*core.Page[*string, *ticketing.Attachment, *ticketing.PaginatedAttachmentList], error) {
	...
	readPageResponse := func(response *ticketing.PaginatedAttachmentList) *core.PageResponse[*string, *ticketing.Attachment, *ticketing.PaginatedAttachmentList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ticketing.Attachment, *ticketing.PaginatedAttachmentList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
