...
func (c *Client) List(
...
) (*core.Page[*string, *ticketing.Comment, *ticketing.PaginatedCommentList], error) {
	...
	readPageResponse := func(response *ticketing.PaginatedCommentList) *core.PageResponse[*string, *ticketing.Comment, *ticketing.PaginatedCommentList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *ticketing.Comment, *ticketing.PaginatedCommentList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
