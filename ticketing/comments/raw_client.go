...
func (r *RawClient) Create(
...
) (*core.Response[*ticketing.CommentResponse], error) {
	...
	return &core.Response[*ticketing.CommentResponse]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*ticketing.Comment], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/ticketing/v1/comments/%v",
		id,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
	...
	return &core.Response[*ticketing.Comment]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
