...
var (
	...
	ticketsListRequestFieldCreatorIds          = big.NewInt(1 << 9)
	ticketsListRequestFieldCursor              = big.NewInt(1 << 10)
	ticketsListRequestFieldDueAfter            = big.NewInt(1 << 11)
	ticketsListRequestFieldDueBefore           = big.NewInt(1 << 12)
	ticketsListRequestFieldExpand              = big.NewInt(1 << 13)
	ticketsListRequestFieldIncludeDeletedData  = big.NewInt(1 << 14)
	ticketsListRequestFieldIncludeRemoteData   = big.NewInt(1 << 15)
	ticketsListRequestFieldIncludeRemoteFields = big.NewInt(1 << 16)
	ticketsListRequestFieldIncludeShellData    = big.NewInt(1 << 17)
	ticketsListRequestFieldModifiedAfter       = big.NewInt(1 << 18)
	ticketsListRequestFieldModifiedBefore      = big.NewInt(1 << 19)
	ticketsListRequestFieldName                = big.NewInt(1 << 20)
	ticketsListRequestFieldPageSize            = big.NewInt(1 << 21)
	ticketsListRequestFieldParentTicketId      = big.NewInt(1 << 22)
	ticketsListRequestFieldPriority            = big.NewInt(1 << 23)
	ticketsListRequestFieldRemoteCreatedAfter  = big.NewInt(1 << 24)
...
type TicketsListRequest struct {
	...
	CreatorIds *string `json:"-" url:"creator_ids,omitempty"`
...
// SetCreatorIds sets the CreatorIds field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (t *TicketsListRequest) SetCreatorIds(creatorIds *string) {
	t.CreatorIds = creatorIds
	t.require(ticketsListRequestFieldCreatorIds)
}
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (t *TicketsListRequest) SetName(name *string) {
	t.Name = name
	t.require(ticketsListRequestFieldName)
}
