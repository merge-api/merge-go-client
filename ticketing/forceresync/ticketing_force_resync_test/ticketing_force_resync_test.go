...
package ticketing_force_resync_test
...
func TestTicketingForceResyncSyncStatusResyncCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ticketing.ForceResync.SyncStatusResyncCreate(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/ticketing/v1/sync-status/resync", nil, 1)
}
