...
var (
	...
	teamsListRequestFieldIncludeDeletedData = big.NewInt(1 << 3)
	teamsListRequestFieldIncludeRemoteData  = big.NewInt(1 << 4)
	teamsListRequestFieldIncludeShellData   = big.NewInt(1 << 5)
	teamsListRequestFieldModifiedAfter      = big.NewInt(1 << 6)
	teamsListRequestFieldModifiedBefore     = big.NewInt(1 << 7)
	teamsListRequestFieldPageSize           = big.NewInt(1 << 8)
	teamsListRequestFieldRemoteId           = big.NewInt(1 << 9)
)
...
var (
	teamsRetrieveRequestFieldIncludeRemoteData = big.NewInt(1 << 0)
	teamsRetrieveRequestFieldIncludeShellData  = big.NewInt(1 << 1)
)
