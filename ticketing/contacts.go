...
var (
	...
	contactsListRequestFieldExpand             = big.NewInt(1 << 3)
	contactsListRequestFieldIncludeDeletedData = big.NewInt(1 << 4)
	contactsListRequestFieldIncludeRemoteData  = big.NewInt(1 << 5)
	contactsListRequestFieldIncludeShellData   = big.NewInt(1 << 6)
	contactsListRequestFieldModifiedAfter      = big.NewInt(1 << 7)
	contactsListRequestFieldModifiedBefore     = big.NewInt(1 << 8)
	contactsListRequestFieldPageSize           = big.NewInt(1 << 9)
	contactsListRequestFieldRemoteId           = big.NewInt(1 << 10)
)
