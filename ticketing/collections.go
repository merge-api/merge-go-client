...
var (
	...
	collectionsListRequestFieldPageSize           = big.NewInt(1 << 10)
	collectionsListRequestFieldParentCollectionId = big.NewInt(1 << 11)
	collectionsListRequestFieldRemoteFields       = big.NewInt(1 << 12)
	collectionsListRequestFieldRemoteId           = big.NewInt(1 << 13)
	collectionsListRequestFieldShowEnumOrigins    = big.NewInt(1 << 14)
)
