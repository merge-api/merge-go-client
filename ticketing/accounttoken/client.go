...
type Client interface {
	Retrieve(ctx context.Context, publicToken string) (*ticketing.AccountToken, error)
}
...
func (c *client) Retrieve(ctx context.Context, publicToken string) (*ticketing.AccountToken, error) {
