...
package accounting_passthrough_test
...
func TestAccountingPassthroughCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.Passthrough.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/accounting/v1/passthrough", nil, 1)
}
