...
type GeneralLedgerTransactionLine struct {
	...
	BaseCurrency *GeneralLedgerTransactionLineBaseCurrency `json:"base_currency,omitempty" url:"base_currency,omitempty"`
	...
	TrackingCategories  []*TrackingCategory               `json:"tracking_categories,omitempty" url:"tracking_categories,omitempty"`
...
func (g *GeneralLedgerTransactionLine) GetBaseCurrency() *GeneralLedgerTransactionLineBaseCurrency {
	if g == nil {
		return nil
	}
...
func (g *GeneralLedgerTransactionLine) GetTrackingCategories() []*TrackingCategory {
	if g == nil {
		return nil
	}
	return g.TrackingCategories
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (g *GeneralLedgerTransactionLine) SetBaseCurrency(baseCurrency *GeneralLedgerTransactionLineBaseCurrency) {
...
// SetTrackingCategories sets the TrackingCategories field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (g *GeneralLedgerTransactionLine) SetTrackingCategories(trackingCategories []*TrackingCategory) {
	g.TrackingCategories = trackingCategories
...
func (g *GeneralLedgerTransactionLineBaseCurrency) GetTransactionCurrencyEnum() TransactionCurrencyEnum {
	if g == nil {
		return ""
	}
...
func (g *GeneralLedgerTransactionLineBaseCurrency) GetString() string {
	if g == nil {
		return ""
	}
	return g.String
