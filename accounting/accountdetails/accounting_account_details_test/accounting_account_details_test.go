...
package accounting_account_details_test
...
func TestAccountingAccountDetailsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.AccountDetails.Retrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/account-details", nil, 1)
}
