...
type AccountDetailsAndActions struct {
	...
	Status                  AccountDetailsAndActionsStatusEnum `json:"status" url:"status"`
...
func (a *AccountDetailsAndActions) GetCategory() *CategoryEnum {
	if a == nil {
		return nil
	}
	return a.Category
...
func (a *AccountDetailsAndActions) GetStatus() AccountDetailsAndActionsStatusEnum {
	if a == nil {
		return ""
	}
	return a.Status
