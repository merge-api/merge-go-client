...
func (c *Client) List(
...
) (*core.Page[*accounting.AccountingAttachment], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *accounting.PaginatedAccountingAttachmentList) *internal.PageResponse[*string, *accounting.AccountingAttachment] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *accounting.AccountingAttachment]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
