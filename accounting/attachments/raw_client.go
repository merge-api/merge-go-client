...
func (r *RawClient) Create(
...
) (*core.Response[*accounting.AccountingAttachmentResponse], error) {
	...
	return &core.Response[*accounting.AccountingAttachmentResponse]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*accounting.AccountingAttachment], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/accounting/v1/attachments/%v",
		id,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
	...
	return &core.Response[*accounting.AccountingAttachment]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
