...
func (b *BankFeedAccountRequest) GetCurrency() *TransactionCurrencyEnum {
	if b == nil {
		return nil
	}
	return b.Currency
...
func (b *BankFeedAccountRequest) GetFeedStatus() *FeedStatusEnum {
	if b == nil {
		return nil
	}
	return b.FeedStatus
...
func (b *BankFeedAccountRequest) GetAccountType() *BankFeedAccountAccountTypeEnum {
	if b == nil {
		return nil
	}
