...
type Client interface {
	List(ctx context.Context, request *accounting.CashFlowStatementsListRequest) (*accounting.PaginatedCashFlowStatementList, error)
	Retrieve(ctx context.Context, id string, request *accounting.CashFlowStatementsRetrieveRequest) (*accounting.CashFlowStatement, error)
}
