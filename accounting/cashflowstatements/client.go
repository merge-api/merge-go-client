...
func (c *Client) List(
...
) (*core.Page[*accounting.CashFlowStatement], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *accounting.PaginatedCashFlowStatementList) *internal.PageResponse[*string, *accounting.CashFlowStatement] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *accounting.CashFlowStatement]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
...
func (c *Client) Retrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/accounting/v1/cash-flow-statements/%v",
		id,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
