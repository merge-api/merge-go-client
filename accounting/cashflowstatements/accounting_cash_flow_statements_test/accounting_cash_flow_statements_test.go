...
package accounting_cash_flow_statements_test
...
func TestAccountingCashFlowStatementsListWithWireMock(
	t *testing.T,
) {
...
func TestAccountingCashFlowStatementsRetrieveWithWireMock(
	...
	_, invocationErr := client.Accounting.CashFlowStatements.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/cash-flow-statements/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
