...
package accounting_income_statements_test
...
func TestAccountingIncomeStatementsListWithWireMock(
	t *testing.T,
) {
...
func TestAccountingIncomeStatementsRetrieveWithWireMock(
	...
	_, invocationErr := client.Accounting.IncomeStatements.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/income-statements/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
