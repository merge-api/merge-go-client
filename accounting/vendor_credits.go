...
var (
	applyVendorCreditRequestFieldIsDebugMode   = big.NewInt(1 << 0)
	applyVendorCreditRequestFieldRunAsync      = big.NewInt(1 << 1)
	applyVendorCreditRequestFieldInvoice       = big.NewInt(1 << 2)
	applyVendorCreditRequestFieldAppliedDate   = big.NewInt(1 << 3)
	applyVendorCreditRequestFieldAppliedAmount = big.NewInt(1 << 4)
)

type ApplyVendorCreditRequest struct {
...
func (a *ApplyVendorCreditRequest) require(field *big.Int) {
...
func (a *ApplyVendorCreditRequest) SetIsDebugMode(isDebugMode *bool) {
	a.IsDebugMode = isDebugMode
	a.require(applyVendorCreditRequestFieldIsDebugMode)
}

// SetRunAsync sets the RunAsync field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (a *ApplyVendorCreditRequest) SetRunAsync(runAsync *bool) {
	a.RunAsync = runAsync
	a.require(applyVendorCreditRequestFieldRunAsync)
}

// SetInvoice sets the Invoice field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (a *ApplyVendorCreditRequest) SetInvoice(invoice *string) {
	a.Invoice = invoice
	a.require(applyVendorCreditRequestFieldInvoice)
}

// SetAppliedDate sets the AppliedDate field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (a *ApplyVendorCreditRequest) SetAppliedDate(appliedDate time.Time) {
	a.AppliedDate = appliedDate
	a.require(applyVendorCreditRequestFieldAppliedDate)
}

// SetAppliedAmount sets the AppliedAmount field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (a *ApplyVendorCreditRequest) SetAppliedAmount(appliedAmount string) {
	a.AppliedAmount = appliedAmount
	a.require(applyVendorCreditRequestFieldAppliedAmount)
}

func (a *ApplyVendorCreditRequest) UnmarshalJSON(data []byte) error {
	type unmarshaler ApplyVendorCreditRequest
	var body unmarshaler
	if err := json.Unmarshal(data, &body); err != nil {
		return err
	}
	*a = ApplyVendorCreditRequest(body)
	return nil
}

func (a *ApplyVendorCreditRequest) MarshalJSON() ([]byte, error) {
	type embed ApplyVendorCreditRequest
...
var (
	patchedVendorCreditEndpointRequestFieldIsDebugMode = big.NewInt(1 << 0)
	patchedVendorCreditEndpointRequestFieldRunAsync    = big.NewInt(1 << 1)
	patchedVendorCreditEndpointRequestFieldModel       = big.NewInt(1 << 2)
)

type PatchedVendorCreditEndpointRequest struct {
	// Whether to include debug fields (such as log file links) in the response.
	IsDebugMode *bool `json:"-" url:"is_debug_mode,omitempty"`
	// Whether or not third-party updates should be run asynchronously.
	RunAsync *bool                       `json:"-" url:"run_async,omitempty"`
	Model    *PatchedVendorCreditRequest `json:"model,omitempty" url:"-"`

	// Private bitmask of fields set to an explicit value and therefore not to be omitted
	explicitFields *big.Int `json:"-" url:"-"`
}

func (p *PatchedVendorCreditEndpointRequest) require(field *big.Int) {
...
// SetIsDebugMode sets the IsDebugMode field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditEndpointRequest) SetIsDebugMode(isDebugMode *bool) {
	p.IsDebugMode = isDebugMode
	p.require(patchedVendorCreditEndpointRequestFieldIsDebugMode)
}

// SetRunAsync sets the RunAsync field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditEndpointRequest) SetRunAsync(runAsync *bool) {
	p.RunAsync = runAsync
	p.require(patchedVendorCreditEndpointRequestFieldRunAsync)
}

// SetModel sets the Model field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditEndpointRequest) SetModel(model *PatchedVendorCreditRequest) {
	p.Model = model
	p.require(patchedVendorCreditEndpointRequestFieldModel)
}
...
var (
	patchedVendorCreditRequestFieldNumber              = big.NewInt(1 << 0)
	patchedVendorCreditRequestFieldTransactionDate     = big.NewInt(1 << 1)
	patchedVendorCreditRequestFieldVendor              = big.NewInt(1 << 2)
	patchedVendorCreditRequestFieldCurrency            = big.NewInt(1 << 3)
	patchedVendorCreditRequestFieldExchangeRate        = big.NewInt(1 << 4)
	patchedVendorCreditRequestFieldInclusiveOfTax      = big.NewInt(1 << 5)
	patchedVendorCreditRequestFieldCompany             = big.NewInt(1 << 6)
	patchedVendorCreditRequestFieldTrackingCategories  = big.NewInt(1 << 7)
	patchedVendorCreditRequestFieldIntegrationParams   = big.NewInt(1 << 8)
	patchedVendorCreditRequestFieldLinkedAccountParams = big.NewInt(1 << 9)
	patchedVendorCreditRequestFieldVendorCreditUrl     = big.NewInt(1 << 10)
)

type PatchedVendorCreditRequest struct {
	...
	Currency *PatchedVendorCreditRequestCurrency `json:"currency,omitempty" url:"currency,omitempty"`
...
func (p *PatchedVendorCreditRequest) GetNumber() *string {
	if p == nil {
		return nil
	}
	return p.Number
...
func (p *PatchedVendorCreditRequest) GetTransactionDate() *time.Time {
	if p == nil {
		return nil
	}
...
func (p *PatchedVendorCreditRequest) GetVendor() *string {
	if p == nil {
		return nil
	}
	return p.Vendor
...
func (p *PatchedVendorCreditRequest) GetCurrency() *PatchedVendorCreditRequestCurrency {
	if p == nil {
		return nil
	}
	return p.Currency
...
func (p *PatchedVendorCreditRequest) GetExchangeRate() *string {
	if p == nil {
		return nil
	}
...
func (p *PatchedVendorCreditRequest) GetInclusiveOfTax() *bool {
	if p == nil {
		return nil
	}
...
func (p *PatchedVendorCreditRequest) GetCompany() *string {
	if p == nil {
		return nil
	}
	return p.Company
...
func (p *PatchedVendorCreditRequest) GetTrackingCategories() []*string {
	if p == nil {
		return nil
	}
...
func (p *PatchedVendorCreditRequest) GetIntegrationParams() map[string]interface{} {
	if p == nil {
		return nil
	}
...
func (p *PatchedVendorCreditRequest) GetLinkedAccountParams() map[string]interface{} {
	if p == nil {
		return nil
	}
...
func (p *PatchedVendorCreditRequest) GetVendorCreditUrl() *string {
	if p == nil {
		return nil
	}
	return p.VendorCreditUrl
}

func (p *PatchedVendorCreditRequest) GetExtraProperties() map[string]interface{} {
	return p.extraProperties
}

func (p *PatchedVendorCreditRequest) require(field *big.Int) {
	if p.explicitFields == nil {
		p.explicitFields = big.NewInt(0)
	}
	p.explicitFields.Or(p.explicitFields, field)
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetNumber(number *string) {
	p.Number = number
	p.require(patchedVendorCreditRequestFieldNumber)
}

// SetTransactionDate sets the TransactionDate field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetTransactionDate(transactionDate *time.Time) {
	p.TransactionDate = transactionDate
	p.require(patchedVendorCreditRequestFieldTransactionDate)
}

// SetVendor sets the Vendor field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetVendor(vendor_ *string) {
	p.Vendor = vendor_
	p.require(patchedVendorCreditRequestFieldVendor)
}

// SetCurrency sets the Currency field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetCurrency(currency *PatchedVendorCreditRequestCurrency) {
	p.Currency = currency
	p.require(patchedVendorCreditRequestFieldCurrency)
}

// SetExchangeRate sets the ExchangeRate field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetExchangeRate(exchangeRate *string) {
	p.ExchangeRate = exchangeRate
	p.require(patchedVendorCreditRequestFieldExchangeRate)
}

// SetInclusiveOfTax sets the InclusiveOfTax field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetInclusiveOfTax(inclusiveOfTax *bool) {
	p.InclusiveOfTax = inclusiveOfTax
	p.require(patchedVendorCreditRequestFieldInclusiveOfTax)
}

// SetCompany sets the Company field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetCompany(company *string) {
	p.Company = company
	p.require(patchedVendorCreditRequestFieldCompany)
}

// SetTrackingCategories sets the TrackingCategories field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetTrackingCategories(trackingCategories []*string) {
	p.TrackingCategories = trackingCategories
	p.require(patchedVendorCreditRequestFieldTrackingCategories)
}

// SetIntegrationParams sets the IntegrationParams field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetIntegrationParams(integrationParams map[string]interface{}) {
	p.IntegrationParams = integrationParams
	p.require(patchedVendorCreditRequestFieldIntegrationParams)
}

// SetLinkedAccountParams sets the LinkedAccountParams field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetLinkedAccountParams(linkedAccountParams map[string]interface{}) {
	p.LinkedAccountParams = linkedAccountParams
	p.require(patchedVendorCreditRequestFieldLinkedAccountParams)
}

// SetVendorCreditUrl sets the VendorCreditUrl field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *PatchedVendorCreditRequest) SetVendorCreditUrl(vendorCreditUrl *string) {
	p.VendorCreditUrl = vendorCreditUrl
	p.require(patchedVendorCreditRequestFieldVendorCreditUrl)
}

func (p *PatchedVendorCreditRequest) UnmarshalJSON(data []byte) error {
	type embed PatchedVendorCreditRequest
	...
	*p = PatchedVendorCreditRequest(unmarshaler.embed)
...
func (p *PatchedVendorCreditRequest) MarshalJSON() ([]byte, error) {
	type embed PatchedVendorCreditRequest
	var marshaler = struct {
		embed
		TransactionDate *internal.DateTime `json:"transaction_date,omitempty"`
...
func (p *PatchedVendorCreditRequest) String() string {
	if len(p.rawJSON) > 0 {
		if value, err := internal.StringifyJSON(p.rawJSON); err == nil {
			return value
		}
...
// * `ZWR` - Zimbabwean Dollar (2008)
// * `ZWL` - Zimbabwean Dollar (2009)
type PatchedVendorCreditRequestCurrency struct {
...
func (p *PatchedVendorCreditRequestCurrency) GetTransactionCurrencyEnum() TransactionCurrencyEnum {
	if p == nil {
		return ""
	}
...
func (p *PatchedVendorCreditRequestCurrency) GetString() string {
	if p == nil {
		return ""
	}
	return p.String
...
func (p *PatchedVendorCreditRequestCurrency) UnmarshalJSON(data []byte) error {
...
func (p PatchedVendorCreditRequestCurrency) MarshalJSON() ([]byte, error) {
...
type PatchedVendorCreditRequestCurrencyVisitor interface {
	VisitTransactionCurrencyEnum(TransactionCurrencyEnum) error
	VisitString(string) error
}

func (p *PatchedVendorCreditRequestCurrency) Accept(visitor PatchedVendorCreditRequestCurrencyVisitor) error {
	if p.typ == "TransactionCurrencyEnum" || p.TransactionCurrencyEnum != "" {
...
var (
	...
	vendorCreditRequestFieldVendorCreditUrl     = big.NewInt(1 << 13)
)
...
func (v *VendorCreditRequest) GetVendorCreditUrl() *string {
	if v == nil {
		return nil
	}
...
// SetVendorCreditUrl sets the VendorCreditUrl field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (v *VendorCreditRequest) SetVendorCreditUrl(vendorCreditUrl *string) {
	v.VendorCreditUrl = vendorCreditUrl
	v.require(vendorCreditRequestFieldVendorCreditUrl)
}
