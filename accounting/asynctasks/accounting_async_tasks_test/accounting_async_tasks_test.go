...
package accounting_async_tasks_test
...
func TestAccountingAsyncTasksRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.AsyncTasks.Retrieve(
		context.TODO(),
		"id",
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/async-tasks/id", nil, 1)
}
