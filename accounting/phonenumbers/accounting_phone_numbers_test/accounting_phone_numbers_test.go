...
package accounting_phone_numbers_test
...
func TestAccountingPhoneNumbersRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.PhoneNumbers.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	VerifyRequestCount(t, "GET", "/accounting/v1/phone-numbers/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
