...
package accounting_sync_status_test
...
func TestAccountingSyncStatusListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.SyncStatus.List(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/sync-status", map[string]string{"cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "page_size": "1"}, 1)
}
