...
type Client interface {
	List(ctx context.Context, request *accounting.VendorCreditsListRequest) (*accounting.PaginatedVendorCreditList, error)
	Retrieve(ctx context.Context, id string, request *accounting.VendorCreditsRetrieveRequest) (*accounting.VendorCredit, error)
}
...
func (c *client) List(ctx context.Context, request *accounting.VendorCreditsListRequest) (*accounting.PaginatedVendorCreditList, error) {
	...
	endpointURL := baseURL + "/" + "vendor-credits"
...
func (c *client) Retrieve(ctx context.Context, id string, request *accounting.VendorCreditsRetrieveRequest) (*accounting.VendorCredit, error) {
	...
	endpointURL := fmt.Sprintf(baseURL+"/"+"vendor-credits/%v", id)
