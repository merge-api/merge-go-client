...
func (c *Client) List(
...
) (*core.Page[*accounting.VendorCredit], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *accounting.PaginatedVendorCreditList) *internal.PageResponse[*string, *accounting.VendorCredit] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *accounting.VendorCredit]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
