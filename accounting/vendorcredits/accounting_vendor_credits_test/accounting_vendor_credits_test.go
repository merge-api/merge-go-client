...
package accounting_vendor_credits_test
...
func TestAccountingVendorCreditsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.VendorCredits.List(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/vendor-credits", map[string]string{"company_id": "company_id", "created_after": "2024-01-15T09:30:00Z", "created_before": "2024-01-15T09:30:00Z", "cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "include_deleted_data": "true", "include_remote_data": "true", "include_shell_data": "true", "modified_after": "2024-01-15T09:30:00Z", "modified_before": "2024-01-15T09:30:00Z", "page_size": "1", "remote_id": "remote_id", "transaction_date_after": "2024-01-15T09:30:00Z", "transaction_date_before": "2024-01-15T09:30:00Z"}, 1)
}

func TestAccountingVendorCreditsCreateWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Accounting.VendorCredits.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/accounting/v1/vendor-credits", map[string]string{"is_debug_mode": "true", "run_async": "true"}, 1)
}

func TestAccountingVendorCreditsRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Accounting.VendorCredits.Retrieve(
		context.TODO(),
		"id",
		request,
	)
...
func TestAccountingVendorCreditsMetaPostRetrieveWithWireMock(
	...
	_, invocationErr := client.Accounting.VendorCredits.MetaPostRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/vendor-credits/meta/post", nil, 1)
}
