...
package accounting_contacts_test
...
func TestAccountingContactsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.Contacts.List(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/contacts", map[string]string{"company_id": "company_id", "created_after": "2024-01-15T09:30:00Z", "created_before": "2024-01-15T09:30:00Z", "cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "email_address": "email_address", "include_deleted_data": "true", "include_remote_data": "true", "include_remote_fields": "true", "include_shell_data": "true", "is_customer": "is_customer", "is_supplier": "is_supplier", "modified_after": "2024-01-15T09:30:00Z", "modified_before": "2024-01-15T09:30:00Z", "name": "name", "page_size": "1", "remote_fields": "status", "remote_id": "remote_id", "show_enum_origins": "status", "status": ""}, 1)
}

func TestAccountingContactsCreateWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Accounting.Contacts.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/accounting/v1/contacts", map[string]string{"is_debug_mode": "true", "run_async": "true"}, 1)
}

func TestAccountingContactsRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Accounting.Contacts.Retrieve(
		context.TODO(),
		"id",
		request,
	)
...
func TestAccountingContactsMetaPostRetrieveWithWireMock(
	...
	_, invocationErr := client.Accounting.Contacts.MetaPostRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/contacts/meta/post", nil, 1)
}

func TestAccountingContactsRemoteFieldClassesListWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Accounting.Contacts.RemoteFieldClassesList(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/contacts/remote-field-classes", map[string]string{"cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "include_deleted_data": "true", "include_remote_data": "true", "include_shell_data": "true", "is_common_model_field": "true", "is_custom": "true", "page_size": "1"}, 1)
}
