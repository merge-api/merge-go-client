...
func (r *RawClient) Create(
...
) (*core.Response[*accounting.ContactResponse], error) {
	...
	return &core.Response[*accounting.ContactResponse]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*accounting.Contact], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*accounting.Contact]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) MetaPatchRetrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/accounting/v1/contacts/meta/patch/%v",
		id,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
