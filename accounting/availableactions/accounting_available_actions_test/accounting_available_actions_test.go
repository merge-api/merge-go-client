...
package accounting_available_actions_test
...
func TestAccountingAvailableActionsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.AvailableActions.Retrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/available-actions", nil, 1)
}
