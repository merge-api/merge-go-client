...
package accounting_employees_test
...
func TestAccountingEmployeesListWithWireMock(
	t *testing.T,
) {
...
func TestAccountingEmployeesRetrieveWithWireMock(
	...
	_, invocationErr := client.Accounting.Employees.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/employees/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
