...
func (c *Client) List(
...
) (*core.Page[*string, *accounting.Employee], error) {
	...
	readPageResponse := func(response *accounting.PaginatedEmployeeList) *core.PageResponse[*string, *accounting.Employee] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *accounting.Employee]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
