...
package accounting_field_mapping_test
...
func TestAccountingFieldMappingFieldMappingsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.FieldMapping.FieldMappingsRetrieve(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/field-mappings", map[string]string{"exclude_remote_field_metadata": "true"}, 1)
}

func TestAccountingFieldMappingFieldMappingsCreateWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Accounting.FieldMapping.FieldMappingsCreate(
		context.TODO(),
		request,
	)
...
func TestAccountingFieldMappingFieldMappingsPartialUpdateWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
...
func TestAccountingFieldMappingRemoteFieldsRetrieveWithWireMock(
	...
	_, invocationErr := client.Accounting.FieldMapping.RemoteFieldsRetrieve(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/remote-fields", map[string]string{"common_models": "common_models", "include_example_values": "include_example_values"}, 1)
}

func TestAccountingFieldMappingTargetFieldsRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Accounting.FieldMapping.TargetFieldsRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/target-fields", nil, 1)
}
