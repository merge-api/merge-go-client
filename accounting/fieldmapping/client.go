...
func (c *Client) FieldMappingsRetrieve(ctx context.Context, request *accounting.FieldMappingsRetrieveRequest) (*accounting.FieldMappingApiInstanceResponse, error) {
...
func (c *Client) FieldMappingsDestroy(ctx context.Context, fieldMappingId string) (*accounting.FieldMappingInstanceResponse, error) {
	...
	endpointURL := fmt.Sprintf(baseURL+"/"+"accounting/v1/field-mappings/%v", fieldMappingId)
