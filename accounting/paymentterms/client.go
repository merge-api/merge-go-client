...
func (c *Client) List(
...
) (*core.Page[*accounting.PaymentTerm], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *accounting.PaginatedPaymentTermList) *internal.PageResponse[*string, *accounting.PaymentTerm] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *accounting.PaymentTerm]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
...
func (c *Client) Retrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/accounting/v1/payment-terms/%v",
		id,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
	...
	var response *accounting.PaymentTerm
