...
func (r *RawClient) Create(
...
) (*core.Response[*accounting.AsyncPassthroughReciept], error) {
	...
	return &core.Response[*accounting.AsyncPassthroughReciept]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*accounting.AsyncPassthroughRetrieveResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/accounting/v1/async-passthrough/%v",
	...
	return &core.Response[*accounting.AsyncPassthroughRetrieveResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
