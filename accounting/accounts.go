...
func (a *AccountRequest) GetClassification() *ClassificationEnum {
	if a == nil {
		return nil
	}
...
func (a *AccountRequest) GetAccountType() *AccountAccountTypeEnum {
	if a == nil {
		return nil
	}
...
func (a *AccountRequest) GetStatus() *AccountStatusEnum {
	if a == nil {
		return nil
	}
	return a.Status
...
func (a *AccountRequest) GetCurrency() *TransactionCurrencyEnum {
	if a == nil {
		return nil
	}
	return a.Currency
