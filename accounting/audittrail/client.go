...
type Client interface {
	List(ctx context.Context, request *accounting.AuditTrailListRequest) (*accounting.PaginatedAuditLogEventList, error)
}
...
func (c *client) List(ctx context.Context, request *accounting.AuditTrailListRequest) (*accounting.PaginatedAuditLogEventList, error) {
	...
	var response *accounting.PaginatedAuditLogEventList
