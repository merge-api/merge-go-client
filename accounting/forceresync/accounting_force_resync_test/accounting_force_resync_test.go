...
package accounting_force_resync_test
...
func TestAccountingForceResyncSyncStatusResyncCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.ForceResync.SyncStatusResyncCreate(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/accounting/v1/sync-status/resync", nil, 1)
}
