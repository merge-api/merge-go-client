...
package accounting_addresses_test
...
func TestAccountingAddressesRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.Addresses.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	VerifyRequestCount(t, "GET", "/accounting/v1/addresses/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true", "remote_fields": "type", "show_enum_origins": "type"}, 1)
}
