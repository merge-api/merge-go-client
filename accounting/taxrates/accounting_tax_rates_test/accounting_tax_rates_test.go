...
package accounting_tax_rates_test
...
func TestAccountingTaxRatesListWithWireMock(
	t *testing.T,
) {
...
func TestAccountingTaxRatesRetrieveWithWireMock(
	...
	_, invocationErr := client.Accounting.TaxRates.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/tax-rates/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
