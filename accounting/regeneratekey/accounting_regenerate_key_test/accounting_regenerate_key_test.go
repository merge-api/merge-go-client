...
package accounting_regenerate_key_test
...
func TestAccountingRegenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.RegenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/accounting/v1/regenerate-key", nil, 1)
}
