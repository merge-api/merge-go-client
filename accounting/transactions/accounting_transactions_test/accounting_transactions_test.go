...
package accounting_transactions_test
...
func TestAccountingTransactionsListWithWireMock(
	t *testing.T,
) {
...
func TestAccountingTransactionsRetrieveWithWireMock(
	...
	_, invocationErr := client.Accounting.Transactions.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/transactions/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
