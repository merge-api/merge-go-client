...
func (c *Client) List(
...
) (*core.Page[*accounting.Transaction], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *accounting.PaginatedTransactionList) *internal.PageResponse[*string, *accounting.Transaction] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *accounting.Transaction]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
...
func (c *Client) Retrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/accounting/v1/transactions/%v",
		id,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
