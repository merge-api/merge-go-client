...
package accounting_generate_key_test
...
func TestAccountingGenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.GenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/accounting/v1/generate-key", nil, 1)
}
