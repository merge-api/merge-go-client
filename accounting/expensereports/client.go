...
func (c *Client) List(
...
) (*core.Page[*string, *accounting.ExpenseReport, *accounting.PaginatedExpenseReportList], error) {
	...
	readPageResponse := func(response *accounting.PaginatedExpenseReportList) *core.PageResponse[*string, *accounting.ExpenseReport, *accounting.PaginatedExpenseReportList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *accounting.ExpenseReport, *accounting.PaginatedExpenseReportList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
...
func (c *Client) Create(
	...
	opts ...option.RequestOption,
) (*accounting.ExpenseReportResponse, error) {
...
func (c *Client) LinesList(
	ctx context.Context,
	expenseReportId string,
	request *accounting.ExpenseReportsLinesListRequest,
	opts ...option.RequestOption,
) (*core.Page[*string, *accounting.ExpenseReportLine, *accounting.PaginatedExpenseReportLineList], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/accounting/v1/expense-reports/%v/lines",
		expenseReportId,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
	...
	readPageResponse := func(response *accounting.PaginatedExpenseReportLineList) *core.PageResponse[*string, *accounting.ExpenseReportLine, *accounting.PaginatedExpenseReportLineList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *accounting.ExpenseReportLine, *accounting.PaginatedExpenseReportLineList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
...
func (c *Client) Retrieve(
	...
	opts ...option.RequestOption,
) (*accounting.ExpenseReport, error) {
...
func (c *Client) LinesRemoteFieldClassesList(
	...
	endpointURL := baseURL + "/accounting/v1/expense-reports/lines/remote-field-classes"
	queryParams, err := internal.QueryValues(request)
	if err != nil {
		return nil, err
	}
...
func (c *Client) RemoteFieldClassesList(
	...
	endpointURL := baseURL + "/accounting/v1/expense-reports/remote-field-classes"
	queryParams, err := internal.QueryValues(request)
	if err != nil {
		return nil, err
	}
