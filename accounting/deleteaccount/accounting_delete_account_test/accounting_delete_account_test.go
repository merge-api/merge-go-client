...
package accounting_delete_account_test
...
func TestAccountingDeleteAccountDeleteWithWireMock(
	t *testing.T,
) {
	...
	invocationErr := client.Accounting.DeleteAccount.Delete(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/accounting/v1/delete-account", nil, 1)
}
