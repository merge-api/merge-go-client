...
func (c *Client) List(ctx context.Context, request *accounting.BankFeedTransactionsListRequest) (*accounting.PaginatedBankFeedTransactionList, error) {
	...
	if request.IsProcessed != nil {
		queryParams.Add("is_processed", fmt.Sprintf("%v", *request.IsProcessed))
	}
	...
	var response *accounting.PaginatedBankFeedTransactionList
...
func (c *Client) Create(ctx context.Context, request *accounting.BankFeedTransactionEndpointRequest) (*accounting.BankFeedTransactionResponse, error) {
	baseURL := "https://api.merge.dev/api"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
...
func (c *Client) Retrieve(ctx context.Context, id string, request *accounting.BankFeedTransactionsRetrieveRequest) (*accounting.BankFeedTransaction, error) {
	baseURL := "https://api.merge.dev/api"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := fmt.Sprintf(baseURL+"/"+"accounting/v1/bank-feed-transactions/%v", id)
