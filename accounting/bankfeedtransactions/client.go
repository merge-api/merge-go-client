...
func (c *Client) List(
...
) (*core.Page[*accounting.BankFeedTransaction], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *accounting.PaginatedBankFeedTransactionList) *internal.PageResponse[*string, *accounting.BankFeedTransaction] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *accounting.BankFeedTransaction]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
...
func (c *Client) Create(
	...
	opts ...option.RequestOption,
) (*accounting.BankFeedTransactionResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
...
func (c *Client) Retrieve(
	...
	opts ...option.RequestOption,
) (*accounting.BankFeedTransaction, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
