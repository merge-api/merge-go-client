...
package accounting_balance_sheets_test
...
func TestAccountingBalanceSheetsListWithWireMock(
	t *testing.T,
) {
...
func TestAccountingBalanceSheetsRetrieveWithWireMock(
	...
	_, invocationErr := client.Accounting.BalanceSheets.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/balance-sheets/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
