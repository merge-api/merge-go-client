...
package accounting_tracking_categories_test
...
func TestAccountingTrackingCategoriesListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.TrackingCategories.List(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/tracking-categories", map[string]string{"category_type": "", "company_id": "company_id", "created_after": "2024-01-15T09:30:00Z", "created_before": "2024-01-15T09:30:00Z", "cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "include_deleted_data": "true", "include_remote_data": "true", "include_shell_data": "true", "modified_after": "2024-01-15T09:30:00Z", "modified_before": "2024-01-15T09:30:00Z", "name": "name", "page_size": "1", "remote_fields": "status", "remote_id": "remote_id", "show_enum_origins": "status", "status": ""}, 1)
}

func TestAccountingTrackingCategoriesRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Accounting.TrackingCategories.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/tracking-categories/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true", "remote_fields": "status", "show_enum_origins": "status"}, 1)
}
