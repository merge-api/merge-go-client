...
type Client interface {
	List(ctx context.Context, request *accounting.TrackingCategoriesListRequest) (*accounting.PaginatedTrackingCategoryList, error)
	Retrieve(ctx context.Context, id string, request *accounting.TrackingCategoriesRetrieveRequest) (*accounting.TrackingCategory, error)
}
...
func (c *client) List(ctx context.Context, request *accounting.TrackingCategoriesListRequest) (*accounting.PaginatedTrackingCategoryList, error) {
	...
	endpointURL := baseURL + "/" + "tracking-categories"
	...
	var response *accounting.PaginatedTrackingCategoryList
...
func (c *client) Retrieve(ctx context.Context, id string, request *accounting.TrackingCategoriesRetrieveRequest) (*accounting.TrackingCategory, error) {
	...
	endpointURL := fmt.Sprintf(baseURL+"/"+"tracking-categories/%v", id)
