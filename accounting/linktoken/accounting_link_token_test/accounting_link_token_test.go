...
package accounting_link_token_test
...
func TestAccountingLinkTokenCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounting.LinkToken.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/accounting/v1/link-token", nil, 1)
}
