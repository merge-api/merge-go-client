...
func (c *Client) List(
...
) (*core.Page[*accounting.PurchaseOrder], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *accounting.PaginatedPurchaseOrderList) *internal.PageResponse[*string, *accounting.PurchaseOrder] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *accounting.PurchaseOrder]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
...
func (c *Client) Create(
	...
	opts ...option.RequestOption,
) (*accounting.PurchaseOrderResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
...
func (c *Client) Retrieve(
	...
	opts ...option.RequestOption,
) (*accounting.PurchaseOrder, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/accounting/v1/purchase-orders/%v",
		id,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
