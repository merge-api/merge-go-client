...
func (r *RawClient) List(
...
) (*core.Response[*accounting.PaginatedProjectList], error) {
	...
	var response *accounting.PaginatedProjectList
	...
	return &core.Response[*accounting.PaginatedProjectList]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*accounting.Project], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/accounting/v1/projects/%v",
		id,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
	...
	var response *accounting.Project
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*accounting.Project]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
