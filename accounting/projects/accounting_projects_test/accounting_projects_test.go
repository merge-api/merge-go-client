...
package accounting_projects_test
...
func TestAccountingProjectsListWithWireMock(
	t *testing.T,
) {
...
func TestAccountingProjectsRetrieveWithWireMock(
	...
	_, invocationErr := client.Accounting.Projects.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/accounting/v1/projects/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
