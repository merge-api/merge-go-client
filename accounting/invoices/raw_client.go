...
func (r *RawClient) Create(
...
) (*core.Response[*accounting.InvoiceResponse], error) {
	...
	return &core.Response[*accounting.InvoiceResponse]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*accounting.Invoice], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*accounting.Invoice]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
