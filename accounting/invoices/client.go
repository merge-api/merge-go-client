...
type Client interface {
	List(ctx context.Context, request *accounting.InvoicesListRequest) (*accounting.PaginatedInvoiceList, error)
	Create(ctx context.Context, request *accounting.InvoiceEndpointRequest) (*accounting.InvoiceResponse, error)
	Retrieve(ctx context.Context, id string, request *accounting.InvoicesRetrieveRequest) (*accounting.Invoice, error)
...
func (c *client) List(ctx context.Context, request *accounting.InvoicesListRequest) (*accounting.PaginatedInvoiceList, error) {
	...
	var response *accounting.PaginatedInvoiceList
...
func (c *client) Retrieve(ctx context.Context, id string, request *accounting.InvoicesRetrieveRequest) (*accounting.Invoice, error) {
	...
	endpointURL := fmt.Sprintf(baseURL+"/"+"invoices/%v", id)
...
func (c *client) MetaPostRetrieve(ctx context.Context) (*accounting.MetaResponse, error) {
	...
	endpointURL := baseURL + "/" + "invoices/meta/post"
