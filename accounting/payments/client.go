...
func (c *Client) List(
...
) (*core.Page[*accounting.Payment], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *accounting.PaginatedPaymentList) *internal.PageResponse[*string, *accounting.Payment] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *accounting.Payment]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
...
func (c *Client) Create(
	...
	opts ...option.RequestOption,
) (*accounting.PaymentResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
