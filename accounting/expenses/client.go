...
func (c *Client) List(ctx context.Context, request *accounting.ExpensesListRequest) (*accounting.PaginatedExpenseList, error) {
	...
	var response *accounting.PaginatedExpenseList
...
func (c *Client) LinesRemoteFieldClassesList(ctx context.Context, request *accounting.ExpensesLinesRemoteFieldClassesListRequest) (*accounting.PaginatedRemoteFieldClassList, error) {
	baseURL := "https://api.merge.dev/api"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
...
// Returns a list of `RemoteFieldClass` objects.
func (c *Client) RemoteFieldClassesList(ctx context.Context, request *accounting.ExpensesRemoteFieldClassesListRequest) (*accounting.PaginatedRemoteFieldClassList, error) {
	baseURL := "https://api.merge.dev/api"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
