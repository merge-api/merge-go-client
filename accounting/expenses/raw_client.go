...
func (r *RawClient) Create(
...
) (*core.Response[*accounting.ExpenseResponse], error) {
	...
	return &core.Response[*accounting.ExpenseResponse]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*accounting.Expense], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*accounting.Expense]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) BulkCreate(
	...
	endpointURL := baseURL + "/accounting/v1/expenses/bulk"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
...
func (r *RawClient) BulkRetrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/accounting/v1/expenses/bulk/%v",
		batchId,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
