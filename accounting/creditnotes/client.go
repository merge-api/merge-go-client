...
func (c *Client) List(
...
) (*core.Page[*accounting.CreditNote], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *accounting.PaginatedCreditNoteList) *internal.PageResponse[*string, *accounting.CreditNote] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *accounting.CreditNote]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
