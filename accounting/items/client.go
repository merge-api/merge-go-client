...
func (c *Client) List(
...
) (*core.Page[*accounting.Item], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *accounting.PaginatedItemList) *internal.PageResponse[*string, *accounting.Item] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *accounting.Item]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
