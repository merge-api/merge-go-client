...
type Client interface {
	List(ctx context.Context, request *accounting.ItemsListRequest) (*accounting.PaginatedItemList, error)
	Retrieve(ctx context.Context, id string, request *accounting.ItemsRetrieveRequest) (*accounting.Item, error)
}
...
func (c *client) Retrieve(ctx context.Context, id string, request *accounting.ItemsRetrieveRequest) (*accounting.Item, error) {
	...
	endpointURL := fmt.Sprintf(baseURL+"/"+"items/%v", id)
