...
// ClientWithHeaderAccountToken sets the accountToken header on every request.
//
// Token identifying the end user.
func ClientWithHeaderAccountToken(accountToken *string) core.ClientOption {
	return func(opts *core.ClientOptions) {
		opts.AccountToken = accountToken
	}
}
