...
func TestCrmForceResyncSyncStatusResyncCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Crm.ForceResync.SyncStatusResyncCreate(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/crm/v1/sync-status/resync", nil, 1)
}
