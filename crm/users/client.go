...
func (c *Client) List(
	...
	readPageResponse := func(response *crm.PaginatedUserList) *internal.PageResponse[*string, *crm.User] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *crm.User]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
