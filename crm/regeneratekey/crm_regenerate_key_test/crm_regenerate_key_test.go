...
package crm_regenerate_key_test
...
func TestCrmRegenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Crm.RegenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/crm/v1/regenerate-key", nil, 1)
}
