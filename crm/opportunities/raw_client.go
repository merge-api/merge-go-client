...
func (r *RawClient) Create(
...
) (*core.Response[*crm.OpportunityResponse], error) {
	...
	return &core.Response[*crm.OpportunityResponse]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*crm.Opportunity], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*crm.Opportunity]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
