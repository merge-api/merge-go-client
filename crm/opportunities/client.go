...
func (c *Client) List(
...
) (*core.Page[*string, *crm.Opportunity, *crm.PaginatedOpportunityList], error) {
	...
	readPageResponse := func(response *crm.PaginatedOpportunityList) *core.PageResponse[*string, *crm.Opportunity, *crm.PaginatedOpportunityList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *crm.Opportunity, *crm.PaginatedOpportunityList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
