...
func (c *Client) List(
...
) (*core.Page[*crm.Opportunity], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *crm.PaginatedOpportunityList) *internal.PageResponse[*string, *crm.Opportunity] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *crm.Opportunity]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
...
func (c *Client) Retrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/crm/v1/opportunities/%v",
		id,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
...
func (c *Client) MetaPatchRetrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/crm/v1/opportunities/meta/patch/%v",
		id,
	)
	headers := internal.MergeHeaders(
		c.header.Clone(),
