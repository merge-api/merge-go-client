...
func TestCrmLeadsListWithWireMock(
	t *testing.T,
) {
...
func TestCrmLeadsCreateWithWireMock(
	...
	_, invocationErr := client.Crm.Leads.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/crm/v1/leads", map[string]string{"is_debug_mode": "true", "run_async": "true"}, 1)
}

func TestCrmLeadsRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Crm.Leads.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/crm/v1/leads/id", map[string]string{"include_remote_data": "true", "include_remote_fields": "true", "include_shell_data": "true"}, 1)
}

func TestCrmLeadsMetaPostRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Crm.Leads.MetaPostRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/crm/v1/leads/meta/post", nil, 1)
}

func TestCrmLeadsRemoteFieldClassesListWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Crm.Leads.RemoteFieldClassesList(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/crm/v1/leads/remote-field-classes", map[string]string{"cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "include_deleted_data": "true", "include_remote_data": "true", "include_remote_fields": "true", "include_shell_data": "true", "is_common_model_field": "true", "is_custom": "true", "page_size": "1"}, 1)
}
