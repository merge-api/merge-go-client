...
func (c *Client) List(
...
) (*core.Page[*string, *crm.Lead, *crm.PaginatedLeadList], error) {
	...
	readPageResponse := func(response *crm.PaginatedLeadList) *core.PageResponse[*string, *crm.Lead, *crm.PaginatedLeadList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *crm.Lead, *crm.PaginatedLeadList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
