...
func (c *Client) List(
...
) (*core.Page[*crm.AccountDetailsAndActions], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *crm.PaginatedAccountDetailsAndActionsList) *internal.PageResponse[*string, *crm.AccountDetailsAndActions] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *crm.AccountDetailsAndActions]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
