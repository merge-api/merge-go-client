...
type Client interface {
	List(ctx context.Context, request *crm.LinkedAccountsListRequest) (*crm.PaginatedAccountDetailsAndActionsList, error)
}
...
func (c *client) List(ctx context.Context, request *crm.LinkedAccountsListRequest) (*crm.PaginatedAccountDetailsAndActionsList, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "api/crm/v1/linked-accounts"
	...
	var response *crm.PaginatedAccountDetailsAndActionsList
