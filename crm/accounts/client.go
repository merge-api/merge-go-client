...
func (c *Client) List(
	...
	readPageResponse := func(response *crm.PaginatedAccountList) *internal.PageResponse[*string, *crm.Account] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *crm.Account]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
