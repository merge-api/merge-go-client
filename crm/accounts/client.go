...
func (c *Client) List(
...
) (*core.Page[*string, *crm.Account], error) {
	...
	readPageResponse := func(response *crm.PaginatedAccountList) *core.PageResponse[*string, *crm.Account] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *crm.Account]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
