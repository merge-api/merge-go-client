...
func (r *RawClient) Create(
...
) (*core.Response[*crm.EngagementResponse], error) {
	...
	return &core.Response[*crm.EngagementResponse]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*crm.Engagement], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*crm.Engagement]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
