...
func (r *RawClient) Create(
...
) (*core.Response[*crm.TaskResponse], error) {
	...
	return &core.Response[*crm.TaskResponse]{
...
func (r *RawClient) MetaPatchRetrieve(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/crm/v1/tasks/meta/patch/%v",
		id,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
