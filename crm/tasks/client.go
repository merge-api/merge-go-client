...
func (c *Client) List(
	...
	readPageResponse := func(response *crm.PaginatedTaskList) *internal.PageResponse[*string, *crm.Task] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *crm.Task]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
