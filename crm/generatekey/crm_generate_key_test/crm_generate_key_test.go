...
func TestCrmGenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Crm.GenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/crm/v1/generate-key", nil, 1)
}
