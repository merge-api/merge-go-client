...
func TestCrmLinkTokenCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Crm.LinkToken.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/crm/v1/link-token", nil, 1)
}
