...
type Client interface {
	List(ctx context.Context, request *crm.AuditTrailListRequest) (*crm.PaginatedAuditLogEventList, error)
}
...
func (c *client) List(ctx context.Context, request *crm.AuditTrailListRequest) (*crm.PaginatedAuditLogEventList, error) {
	...
	var response *crm.PaginatedAuditLogEventList
