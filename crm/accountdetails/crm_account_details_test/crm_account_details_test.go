...
package crm_account_details_test
...
func TestCrmAccountDetailsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Crm.AccountDetails.Retrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/crm/v1/account-details", nil, 1)
}
