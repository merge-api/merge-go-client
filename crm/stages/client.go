...
func (c *Client) List(
...
) (*core.Page[*string, *crm.Stage, *crm.PaginatedStageList], error) {
	...
	readPageResponse := func(response *crm.PaginatedStageList) *core.PageResponse[*string, *crm.Stage, *crm.PaginatedStageList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *crm.Stage, *crm.PaginatedStageList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
