...
func (c *Client) List(
...
) (*core.Page[*string, *crm.Stage], error) {
	...
	readPageResponse := func(response *crm.PaginatedStageList) *core.PageResponse[*string, *crm.Stage] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *crm.Stage]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
