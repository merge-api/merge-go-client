...
package crm_delete_account_test
...
func TestCrmDeleteAccountDeleteWithWireMock(
	t *testing.T,
) {
	...
	invocationErr := client.Crm.DeleteAccount.Delete(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/crm/v1/delete-account", nil, 1)
}
