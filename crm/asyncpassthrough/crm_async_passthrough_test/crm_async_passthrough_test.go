...
package crm_async_passthrough_test
...
func TestCrmAsyncPassthroughCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Crm.AsyncPassthrough.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/crm/v1/async-passthrough", nil, 1)
}

func TestCrmAsyncPassthroughRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Crm.AsyncPassthrough.Retrieve(
		context.TODO(),
		"async_passthrough_receipt_id",
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/crm/v1/async-passthrough/async_passthrough_receipt_id", nil, 1)
}
