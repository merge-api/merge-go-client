...
func TestCrmPassthroughCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Crm.Passthrough.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/crm/v1/passthrough", nil, 1)
}
