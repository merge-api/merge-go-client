...
type Address struct {
	...
	// * `BILLING` - BILLING
	// * `SHIPPING` - SHIPPING
	AddressType *AddressTypeEnum `json:"address_type,omitempty" url:"address_type,omitempty"`
...
func (a *AddressRequest) GetAddressType() *AddressTypeEnum {
	if a == nil {
		return nil
	}
	return a.AddressType
...
func (a *AssociationType) GetCardinality() *CardinalityEnum {
	if a == nil {
		return nil
	}
...
func (e *EngagementType) GetActivityType() *ActivityTypeEnum {
	if e == nil {
		return nil
	}
