...
**expand:** `*ticketing.CollectionsListRequestExpandItem` — Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces.
...
**expand:** `*ticketing.CollectionsRetrieveRequestExpandItem` — Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces.
