...
type EmployerBenefit struct {
	...
	// * `RETIREMENT` - RETIREMENT
	// * `OTHER` - OTHER
	BenefitPlanType *BenefitPlanTypeEnum `json:"benefit_plan_type,omitempty" url:"benefit_plan_type,omitempty"`
...
func (e *EmployerBenefit) GetBenefitPlanType() *BenefitPlanTypeEnum {
	if e == nil {
		return nil
	}
