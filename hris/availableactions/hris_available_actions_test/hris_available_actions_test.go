...
package hris_available_actions_test
...
func TestHrisAvailableActionsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Hris.AvailableActions.Retrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/available-actions", nil, 1)
}
