...
type Client interface {
	ConfigurationsList(ctx context.Context) ([]*hris.LinkedAccountSelectiveSyncConfiguration, error)
	ConfigurationsUpdate(ctx context.Context, request *hris.LinkedAccountSelectiveSyncConfigurationListRequest) ([]*hris.LinkedAccountSelectiveSyncConfiguration, error)
	MetaList(ctx context.Context, request *hris.SelectiveSyncMetaListRequest) (*hris.PaginatedConditionSchemaList, error)
}
...
func (c *client) MetaList(ctx context.Context, request *hris.SelectiveSyncMetaListRequest) (*hris.PaginatedConditionSchemaList, error) {
	...
	var response *hris.PaginatedConditionSchemaList
	if err := core.DoRequest(
		ctx,
		c.httpClient,
		endpointURL,
