...
func TestHrisIssuesListWithWireMock(
	t *testing.T,
) {
...
func TestHrisIssuesRetrieveWithWireMock(
	...
	_, invocationErr := client.Hris.Issues.Retrieve(
		context.TODO(),
		"id",
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/issues/id", nil, 1)
}
