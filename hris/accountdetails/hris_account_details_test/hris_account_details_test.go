...
package hris_account_details_test
...
func TestHrisAccountDetailsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Hris.AccountDetails.Retrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/account-details", nil, 1)
}
