...
package hris_force_resync_test
...
func TestHrisForceResyncSyncStatusResyncCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Hris.ForceResync.SyncStatusResyncCreate(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/hris/v1/sync-status/resync", nil, 1)
}
