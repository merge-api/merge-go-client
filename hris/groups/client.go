...
func (c *Client) List(
	...
	readPageResponse := func(response *hris.PaginatedGroupList) *internal.PageResponse[*string, *hris.Group] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *hris.Group]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
