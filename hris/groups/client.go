...
type Client interface {
	List(ctx context.Context, request *hris.GroupsListRequest) (*hris.PaginatedGroupList, error)
	Retrieve(ctx context.Context, id string, request *hris.GroupsRetrieveRequest) (*hris.Group, error)
}
