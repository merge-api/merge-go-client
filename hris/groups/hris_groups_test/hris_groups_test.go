...
func TestHrisGroupsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Hris.Groups.List(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/groups", map[string]string{"created_after": "2024-01-15T09:30:00Z", "created_before": "2024-01-15T09:30:00Z", "cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "include_deleted_data": "true", "include_remote_data": "true", "include_shell_data": "true", "is_commonly_used_as_team": "is_commonly_used_as_team", "modified_after": "2024-01-15T09:30:00Z", "modified_before": "2024-01-15T09:30:00Z", "names": "names", "page_size": "1", "remote_fields": "type", "remote_id": "remote_id", "show_enum_origins": "type", "types": "types"}, 1)
}

func TestHrisGroupsRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Hris.Groups.Retrieve(
		context.TODO(),
		"id",
		request,
	)
