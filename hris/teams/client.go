...
func (c *Client) List(
	...
	readPageResponse := func(response *hris.PaginatedTeamList) *internal.PageResponse[*string, *hris.Team] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *hris.Team]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
