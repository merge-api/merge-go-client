...
func (c *Client) List(
	...
	readPageResponse := func(response *hris.PaginatedBankInfoList) *internal.PageResponse[*string, *hris.BankInfo] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *hris.BankInfo]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
