...
func TestHrisBankInfoListWithWireMock(
	t *testing.T,
) {
...
func TestHrisBankInfoRetrieveWithWireMock(
	...
	_, invocationErr := client.Hris.BankInfo.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/bank-info/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true", "remote_fields": "account_type", "show_enum_origins": "account_type"}, 1)
}
