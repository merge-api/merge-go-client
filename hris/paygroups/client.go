...
type Client interface {
	List(ctx context.Context, request *hris.PayGroupsListRequest) (*hris.PaginatedPayGroupList, error)
	Retrieve(ctx context.Context, id string, request *hris.PayGroupsRetrieveRequest) (*hris.PayGroup, error)
}
...
func (c *client) List(ctx context.Context, request *hris.PayGroupsListRequest) (*hris.PaginatedPayGroupList, error) {
	...
	var response *hris.PaginatedPayGroupList
...
func (c *client) Retrieve(ctx context.Context, id string, request *hris.PayGroupsRetrieveRequest) (*hris.PayGroup, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
