...
func TestHrisPayGroupsListWithWireMock(
	t *testing.T,
) {
...
func TestHrisPayGroupsRetrieveWithWireMock(
	...
	_, invocationErr := client.Hris.PayGroups.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/pay-groups/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
