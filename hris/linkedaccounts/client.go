...
func (c *Client) List(
...
) (*core.Page[*hris.AccountDetailsAndActions], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *hris.PaginatedAccountDetailsAndActionsList) *internal.PageResponse[*string, *hris.AccountDetailsAndActions] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *hris.AccountDetailsAndActions]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
