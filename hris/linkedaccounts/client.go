...
type Client interface {
	List(ctx context.Context, request *hris.LinkedAccountsListRequest) (*hris.PaginatedAccountDetailsAndActionsList, error)
}
...
func (c *client) List(ctx context.Context, request *hris.LinkedAccountsListRequest) (*hris.PaginatedAccountDetailsAndActionsList, error) {
	...
	var response *hris.PaginatedAccountDetailsAndActionsList
