...
func TestHrisEmploymentsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Hris.Employments.List(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/employments", map[string]string{"created_after": "2024-01-15T09:30:00Z", "created_before": "2024-01-15T09:30:00Z", "cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "employee_id": "employee_id", "include_deleted_data": "true", "include_remote_data": "true", "include_shell_data": "true", "modified_after": "2024-01-15T09:30:00Z", "modified_before": "2024-01-15T09:30:00Z", "order_by": "-effective_date", "page_size": "1", "remote_fields": "employment_type", "remote_id": "remote_id", "show_enum_origins": "employment_type"}, 1)
}

func TestHrisEmploymentsRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Hris.Employments.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/employments/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true", "remote_fields": "employment_type", "show_enum_origins": "employment_type"}, 1)
}
