...
func (c *Client) List(
...
) (*core.Page[*string, *hris.EmployerBenefit], error) {
	...
	readPageResponse := func(response *hris.PaginatedEmployerBenefitList) *core.PageResponse[*string, *hris.EmployerBenefit] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *hris.EmployerBenefit]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
