...
func (c *Client) List(
...
) (*core.Page[*string, *hris.EmployerBenefit, *hris.PaginatedEmployerBenefitList], error) {
	...
	readPageResponse := func(response *hris.PaginatedEmployerBenefitList) *core.PageResponse[*string, *hris.EmployerBenefit, *hris.PaginatedEmployerBenefitList] {
		var zeroValue *string
		next := response.GetNext()
		results := response.GetResults()
		return &core.PageResponse[*string, *hris.EmployerBenefit, *hris.PaginatedEmployerBenefitList]{
			Results:  results,
			Response: response,
			Next:     next,
			Done:     next == zeroValue,
