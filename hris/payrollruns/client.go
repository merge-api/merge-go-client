...
type Client interface {
	List(ctx context.Context, request *hris.PayrollRunsListRequest) (*hris.PaginatedPayrollRunList, error)
	Retrieve(ctx context.Context, id string, request *hris.PayrollRunsRetrieveRequest) (*hris.PayrollRun, error)
}
