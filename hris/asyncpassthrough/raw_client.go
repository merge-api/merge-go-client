...
func (r *RawClient) Create(
...
) (*core.Response[*hris.AsyncPassthroughReciept], error) {
	...
	return &core.Response[*hris.AsyncPassthroughReciept]{
...
func (r *RawClient) Retrieve(
	...
	opts ...option.RequestOption,
) (*core.Response[*hris.AsyncPassthroughRetrieveResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*hris.AsyncPassthroughRetrieveResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
