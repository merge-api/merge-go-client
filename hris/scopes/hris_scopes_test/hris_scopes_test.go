...
func TestHrisScopesDefaultScopesRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Hris.Scopes.DefaultScopesRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/default-scopes", nil, 1)
}

func TestHrisScopesLinkedAccountScopesRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Hris.Scopes.LinkedAccountScopesRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/linked-account-scopes", nil, 1)
}

func TestHrisScopesLinkedAccountScopesCreateWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Hris.Scopes.LinkedAccountScopesCreate(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/hris/v1/linked-account-scopes", nil, 1)
}
