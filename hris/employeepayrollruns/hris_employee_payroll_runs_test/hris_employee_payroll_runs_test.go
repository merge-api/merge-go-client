...
package hris_employee_payroll_runs_test
...
func TestHrisEmployeePayrollRunsListWithWireMock(
	t *testing.T,
) {
...
func TestHrisEmployeePayrollRunsRetrieveWithWireMock(
	...
	_, invocationErr := client.Hris.EmployeePayrollRuns.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/employee-payroll-runs/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}
