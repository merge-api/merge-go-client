...
type Client interface {
	List(ctx context.Context, request *hris.EmployeePayrollRunsListRequest) (*hris.PaginatedEmployeePayrollRunList, error)
	Retrieve(ctx context.Context, id string, request *hris.EmployeePayrollRunsRetrieveRequest) (*hris.EmployeePayrollRun, error)
}
...
func (c *client) List(ctx context.Context, request *hris.EmployeePayrollRunsListRequest) (*hris.PaginatedEmployeePayrollRunList, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "api/hris/v1/employee-payroll-runs"
	...
	if request.PayrollRunId != nil {
		queryParams.Add("payroll_run_id", fmt.Sprintf("%v", *request.PayrollRunId))
	}
	...
	var response *hris.PaginatedEmployeePayrollRunList
...
func (c *client) Retrieve(ctx context.Context, id string, request *hris.EmployeePayrollRunsRetrieveRequest) (*hris.EmployeePayrollRun, error) {
	baseURL := "https://api.merge.dev"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := fmt.Sprintf(baseURL+"/"+"api/hris/v1/employee-payroll-runs/%v", id)
