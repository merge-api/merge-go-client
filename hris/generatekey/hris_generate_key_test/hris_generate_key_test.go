...
package hris_generate_key_test
...
func TestHrisGenerateKeyCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Hris.GenerateKey.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/hris/v1/generate-key", nil, 1)
}
