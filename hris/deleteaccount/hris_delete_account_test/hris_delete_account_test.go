...
package hris_delete_account_test
...
func TestHrisDeleteAccountDeleteWithWireMock(
	t *testing.T,
) {
	...
	invocationErr := client.Hris.DeleteAccount.Delete(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/hris/v1/delete-account", nil, 1)
}
