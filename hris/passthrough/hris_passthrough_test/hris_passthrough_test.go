...
func TestHrisPassthroughCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Hris.Passthrough.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/hris/v1/passthrough", nil, 1)
}
