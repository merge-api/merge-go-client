...
func TestHrisDependentsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Hris.Dependents.List(
		context.TODO(),
		request,
	)
...
func TestHrisDependentsRetrieveWithWireMock(
	...
	_, invocationErr := client.Hris.Dependents.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/dependents/id", map[string]string{"include_remote_data": "true", "include_sensitive_fields": "true", "include_shell_data": "true"}, 1)
}
