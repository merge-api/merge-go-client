...
func (c *Client) List(
...
) (*core.Page[*hris.Dependent], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *hris.PaginatedDependentList) *internal.PageResponse[*string, *hris.Dependent] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *hris.Dependent]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
