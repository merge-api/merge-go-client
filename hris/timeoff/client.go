...
func (c *Client) List(
	...
	readPageResponse := func(response *hris.PaginatedTimeOffList) *internal.PageResponse[*string, *hris.TimeOff] {
		var zeroValue *string
		next := response.Next
		results := response.Results
		return &internal.PageResponse[*string, *hris.TimeOff]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
