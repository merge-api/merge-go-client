...
func TestHrisLocationsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Hris.Locations.List(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/locations", map[string]string{"created_after": "2024-01-15T09:30:00Z", "created_before": "2024-01-15T09:30:00Z", "cursor": "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw", "include_deleted_data": "true", "include_remote_data": "true", "include_shell_data": "true", "location_type": "HOME", "modified_after": "2024-01-15T09:30:00Z", "modified_before": "2024-01-15T09:30:00Z", "page_size": "1", "remote_fields": "country", "remote_id": "remote_id", "show_enum_origins": "country"}, 1)
}

func TestHrisLocationsRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Hris.Locations.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/locations/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true", "remote_fields": "country", "show_enum_origins": "country"}, 1)
}
