...
type Client interface {
	List(ctx context.Context, request *hris.LocationsListRequest) (*hris.PaginatedLocationList, error)
	Retrieve(ctx context.Context, id string, request *hris.LocationsRetrieveRequest) (*hris.Location, error)
}
