...
package hris_timesheet_entries_test
...
func TestHrisTimesheetEntriesListWithWireMock(
	t *testing.T,
) {
...
func TestHrisTimesheetEntriesCreateWithWireMock(
	...
	_, invocationErr := client.Hris.TimesheetEntries.Create(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/hris/v1/timesheet-entries", map[string]string{"is_debug_mode": "true", "run_async": "true"}, 1)
}

func TestHrisTimesheetEntriesRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Hris.TimesheetEntries.Retrieve(
		context.TODO(),
		"id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/timesheet-entries/id", map[string]string{"include_remote_data": "true", "include_shell_data": "true"}, 1)
}

func TestHrisTimesheetEntriesMetaPostRetrieveWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Hris.TimesheetEntries.MetaPostRetrieve(
		context.TODO(),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/hris/v1/timesheet-entries/meta/post", nil, 1)
}
